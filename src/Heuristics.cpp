...
LinearConflict::LinearConflict(int x, int y) : x_(x), y_(y)
{}

bool LinearConflict::operator==(const LinearConflict& linearConflict) const
{
	return ((x_ == linearConflict.x_ && y_ == linearConflict.y_) ||
			(x_ == linearConflict.y_ && y_ == linearConflict.x_));
}
