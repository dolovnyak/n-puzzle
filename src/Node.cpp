...
int Node::CalculateHeuristics(const Puzzle &puzzle, Heuristics::Type type) {
    switch (type) {
        case Heuristics::Type::Hamming:
            return Heuristics::GetHammingDistance(puzzle);
        case Heuristics::Type::Manhattan:
            return Heuristics::GetManhattanDistance(puzzle);
